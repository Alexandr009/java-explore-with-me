...
public class AdminCategoryController {
    ...
    public CategoryFullDto createCategory(@RequestBody CategoryPostDto postDto) {
    ...
    public CategoryFullDto updateCategory(@RequestBody CategoryPostDto postDto, @PathVariable("catId") long id) {
